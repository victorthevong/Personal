...
public class IntHistogram implements Histogram<Integer>{
  ...
  public float computeReductionFactor(PredicateOperator predicate,
    ...
    // Use `getNumDistinct()` to get the number of distinct keys.


      if (predicate == PredicateOperator.EQUALS) {
          reductionFactor = (1 / (float)getNumDistinct());

      } else if (predicate == PredicateOperator.GREATER_THAN) {
          reductionFactor = ((float) getMaxValue() - (float) value.getInt()) / (float) (getMaxValue() - (float) getMinValue());

      } else if (predicate == PredicateOperator.LESS_THAN) {
          reductionFactor = ((float)value.getInt() - (float)getMinValue()) / ((float)getMaxValue() - (float)getMinValue());

      } else if (predicate == PredicateOperator.GREATER_THAN_EQUALS) {
          reductionFactor = (1 / (float)getNumDistinct()) + ((float)getMaxValue() - (float)value.getInt()) / ((float)getMaxValue() - (float)getMinValue());

      } else if (predicate == PredicateOperator.LESS_THAN_EQUALS) {
          reductionFactor = 1 / (float)getNumDistinct() + ((float)value.getInt() - (float)getMinValue()) / ((float)getMaxValue() - (float)getMinValue());
