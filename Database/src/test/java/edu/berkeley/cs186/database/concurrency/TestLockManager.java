...
public class TestLockManager {
  ...
  @Test
  @Category(StudentTestP3.class)
  public void test1BasicChecksLockTest() throws InterruptedException {
    ...
    @Test
    @Category(StudentTestP3.class)
    public void test2BasicChecksLockTest2() throws InterruptedException {
    ...
    @Test
    @Category(StudentTestP3.class)
    public void test3BasicHoldsLockTest() throws InterruptedException {
    ...
    @Test
    @Category(StudentTestP3.class)
    public void test4Acquire5LocksTest() throws InterruptedException {

        final LockManager lockMan = new LockManager();
        Thread thread1 = new Thread(new Runnable() {
            public void run() {
        /*Code to run goes inside here */
                lockMan.acquireLock("B", 1, LockManager.LockType.SHARED);
            }
        }, "Transaction 1 Thread");

        thread1.start();

        assertFalse(lockMan.holdsLock("B", 1, LockManager.LockType.SHARED));

        lockMan.acquireLock("B", 1, LockManager.LockType.SHARED);
        assertTrue(lockMan.holdsLock("B", 1, LockManager.LockType.SHARED));
        ...
        assertFalse(lockMan.holdsLock("B", 2, LockManager.LockType.SHARED));

        lockMan.acquireLock("B", 2, LockManager.LockType.SHARED);
        assertTrue(lockMan.holdsLock("B", 2, LockManager.LockType.SHARED));
        ...
        assertFalse(lockMan.holdsLock("B", 3, LockManager.LockType.SHARED));
        ...
        assertFalse(lockMan.holdsLock("B", 4, LockManager.LockType.SHARED));

        lockMan.acquireLock("B", 4, LockManager.LockType.SHARED);
        assertTrue(lockMan.holdsLock("B", 4, LockManager.LockType.SHARED));


        Thread thread5 = new Thread(new Runnable() {
            public void run() {
        /*Code to run goes inside here */
                lockMan.acquireLock("B", 5, LockManager.LockType.SHARED);
            }
        }, "Transaction 1 Thread");
        ...
        assertFalse(lockMan.holdsLock("B", 5, LockManager.LockType.SHARED));

        lockMan.acquireLock("B", 5, LockManager.LockType.SHARED);
        assertTrue(lockMan.holdsLock("B", 5, LockManager.LockType.SHARED));
    ...
    @Test
    @Category(StudentTestP3.class)
    public void test5LockAcquireReleaseHoldTest() throws InterruptedException {
        final LockManager lockMan = new LockManager();
        Thread thread1 = new Thread(new Runnable() {
            public void run() {
        /*Code to run goes inside here */
        ...
        lockMan.releaseLock("B", 4);
        lockMan.releaseLock("B",5);
    ...
    public void test8() throws InterruptedException {
        ...
        assertFalse(lockMan.holdsLock("A", 1, LockManager.LockType.EXCLUSIVE)); //T1 should have shared lock
    }
    ...
    public void test9() throws InterruptedException {
        ...
        assertFalse(lockMan.holdsLock("A", 1, LockManager.LockType.SHARED)); //T1 should have shared lock
    }
    ...
    public void test10() throws InterruptedException {
        ...
        thread2.start();
        thread2.join(100); //waits for thread to finish (timeout of .1 sec)
        assertFalse("Transaction 1 Thread should have finished", thread2.isAlive()); //T1 should not be blocked
