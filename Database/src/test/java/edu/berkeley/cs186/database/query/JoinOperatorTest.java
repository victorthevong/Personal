...
public class JoinOperatorTest {
    ...
    public void test1CheckNoSuchElementException() throws QueryPlanException, DatabaseException, IOException {
        ...
        sourceOperator = new TestSourceOperator();
        transaction = new Database(tempDir.getAbsolutePath()).beginTransaction();
        joinOperator = new BNLJOperator(sourceOperator, sourceOperator, "int", "int", transaction);

        outputIterator = joinOperator.iterator();
        numRecords = 0;

        expectedRecordValues = new ArrayList<DataType>();
        expectedRecordValues.add(new BoolDataType(true));
        expectedRecordValues.add(new IntDataType(1));
        expectedRecordValues.add(new StringDataType("abcde", 5));
        expectedRecordValues.add(new FloatDataType(1.2f));
        ...
        expectedRecordValues.add(new StringDataType("abcde", 5));
        expectedRecordValues.add(new FloatDataType(1.2f));
        expectedRecord = new Record(expectedRecordValues);
    ...
    @Test
    @Category(StudentTestP2.class)
    public void test2DoubleCallingHasNextStillGivesSameNumRecords() throws QueryPlanException, DatabaseException, IOException {
    ...
    @Test
    @Category(StudentTestP2.class)
    public void test3CheckingHasNextCalls() throws QueryPlanException, DatabaseException, IOException {
        ...
        assertEquals(100 * 100, numRecords * 2);
